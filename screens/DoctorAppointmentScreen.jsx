...
import doctorAppointmentSample from "../assets/doctorAppointmentSample";
import familyMember from "../assets/familyMembers";

function DoctorAppointmentScreen({ route, navigation }) {
          ...
          return (
            <Pressable
              onPress={() =>
                ...
                //     params: { index: index,  },
                //   }
                alert("Edit or remove function are not working yet")
              }
